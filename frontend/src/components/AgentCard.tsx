...
const AgentCard = React.memo(({ agent, onClick, size = 'large' }: AgentCardProps) => {
  ...
  if (size === 'small') {
    ...
    return isOnline ? (
      <div
        onClick={onClick}
        className={`rounded-lg border bg-white dark:bg-slate-900 border-slate-200 dark:border-slate-800 shadow-lg shadow-neutral-200/40 dark:shadow-none hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors cursor-pointer max-w-5xl min-w-[620px] w-full self-center`}
      >
