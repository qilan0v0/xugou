        ...
        <div className="p-6">
          ...
          <div className="glass rounded-xl p-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-4 gap-y-1.5 text-xs">
              ...
              {agent.memory_total != null && <div className="flex items-center gap-2"><StackIcon className="text-blue-500 w-3.5 h-3.5 shrink-0" /><span className="text-slate-500">内存:</span><span className="text-slate-700 dark:text-slate-300">{`${(agent.memory_total / 1073741824).toFixed(1)} GiB`}</span></div>}
              ...
              <div className="flex items-center gap-2"><Component1Icon className="text-rose-500 w-3.5 h-3.5 shrink-0" /><span className="text-slate-500">CPU:</span><span className="text-slate-700 dark:text-slate-300">{(agent.cpu_usage || 0).toFixed(1)}%</span></div>
              <div className="flex items-center gap-2"><StackIcon className="text-blue-500 w-3.5 h-3.5 shrink-0" /><span className="text-slate-500">内存:</span><span className="text-slate-700 dark:text-slate-300">{mem}%</span></div>
              <div className="flex items-center gap-2"><StackIcon className="text-red-500 w-3.5 h-3.5 shrink-0" /><span className="text-slate-500">磁盘:</span><span className="text-slate-700 dark:text-slate-300">{disk}%</span></div>
              {agent.process_count != null && <div className="flex items-center gap-2"><Component1Icon className="text-rose-500 w-3.5 h-3.5 shrink-0" /><span className="text-slate-500">进程:</span><span className="text-slate-700 dark:text-slate-300">{agent.process_count}</span></div>}
              {agent.tcp_count != null && <div className="flex items-center gap-2"><ActivityLogIcon className="text-blue-500 w-3.5 h-3.5 shrink-0" /><span className="text-slate-500">TCP:</span><span className="text-slate-700 dark:text-slate-300">{agent.tcp_count}</span></div>}
              {agent.udp_count != null && <div className="flex items-center gap-2"><ActivityLogIcon className="text-sky-500 w-3.5 h-3.5 shrink-0" /><span className="text-slate-500">UDP:</span><span className="text-slate-700 dark:text-slate-300">{agent.udp_count}</span></div>}
              {agent.network_rx != null && <div className="flex items-center gap-2"><ActivityLogIcon className="text-cyan-500 w-3.5 h-3.5 shrink-0" /><span className="text-slate-500">↓下载:</span><span className="text-slate-700 dark:text-slate-300">{agent.network_rx.toFixed(0)} KB/s</span></div>}
              {agent.network_tx != null && <div className="flex items-center gap-2"><ActivityLogIcon className="text-indigo-500 w-3.5 h-3.5 shrink-0" /><span className="text-slate-500">↑上传:</span><span className="text-slate-700 dark:text-slate-300">{agent.network_tx.toFixed(0)} KB/s</span></div>}
            </div>
