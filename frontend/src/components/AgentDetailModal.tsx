        ...
        <div className="p-6">
          ...
          <div className="glass rounded-xl p-4">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-1.5 text-xs">
              ...
              {uptimeStr && <div className="flex items-center gap-2"><Clock size={14} className="text-teal-500 shrink-0" /><span className="text-slate-500 shrink-0">运行:</span><span className="text-slate-700 dark:text-slate-300 truncate">{uptimeStr}</span></div>}
