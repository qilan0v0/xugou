const enUS = {
  translation: {
    ...
    'agent.cpuArch': 'CPU Arch',
    'agent.cpuModel': 'CPU Model',
    'agent.cpuCores': 'CPU Cores',
    'agent.loadAverage': 'Load Average',
    'agent.bootTime': 'Boot Time',
    ...
    'agent.memory': 'Memory',
    'agent.disk': 'Disk',
    'agent.totalTraffic': 'Total Traffic',
    ...
    'agent.expiredAutoRenew': 'Expired·Auto-renew',
    'agent.days': 'd',
    'agent.expiryTime': 'Expiry Time',
    'agent.startTime': 'Start Time',
    'agent.duration': 'Duration',
    'agent.durationUnit.day': 'Day',
    'agent.durationUnit.month': 'Month',
    'agent.durationUnit.year': 'Year',
    ...
    'statusPageConfig.notifications': 'Notifications',
    'statusPageConfig.webhookUrl': 'Webhook URL',
