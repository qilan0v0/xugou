const zhCN = {
  translation: {
    ...
    'agent.cpuArch': 'CPU架构',
    'agent.cpuModel': 'CPU型号',
    'agent.cpuCores': 'CPU核心数',
    'agent.loadAverage': '系统负载',
    'agent.bootTime': '启动时间',
    ...
    'agent.expiry': '到期',
    'agent.expired': '已过期',
    'agent.expiredAutoRenew': '已过期·自动续',
    'agent.days': '天',
    'agent.trafficLimit': '总流量上限',
    'agent.expiryTime': '到期时间',
    'agent.startTime': '开始时间',
    'agent.duration': '使用时长',
    'agent.durationUnit.day': '天',
    'agent.durationUnit.month': '月',
    'agent.durationUnit.year': '年',
    ...
    'agent.form.namePlaceholder': '请输入客户端备注名称',
    'agent.form.created': '已创建',
    ...
    'statusPageConfig.notifications': '告警通知',
